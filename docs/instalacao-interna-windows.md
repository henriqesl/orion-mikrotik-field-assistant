...
Execute o instalador `ORION Field_0.7.3_x64-setup.exe` e confirme que o Windows mostra **BIONIC ORION Internal Code Signing** como publicador da assinatura e **BIONIC** como editor em Aplicativos instalados.
